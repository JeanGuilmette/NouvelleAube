...
class Hexvid(Vid):
    ...
    def paint(self,screen):
        ...
        for i2 in range(round(-bot), round(self.view.h/tile_h2+bot*3) ): #NOTE: 3 seems a bit much, but it works.
            ...
            x -= tile_w/2
            for i1 in range(round(-1), round(self.view.w/tile_wi+1) ):
