#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe start.py -W setup.py
...
start = Target(
    ...
    script="start.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'start'
    # dest_base = "start",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"start.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="start", level="asInvoker")).encode("utf-8")),
